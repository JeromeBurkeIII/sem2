...
public class App {
  ...
  //    I created this section to test display more than one recorde   Create new Application
        App a = new App();
...
// Create new Application
   ...
   /* public Employee getEmployee(int ID)
        ...
        try
        {
            ...
            String strSelect =
                    "SELECT employees.emp_no, employees.first_name, employees.last_name, salaries.salary "
                            ...
                            "AND titles.title = '<title>' " +"ORDER BY employees.emp_no ASC";
     ...
     */
 /*  My tested get  public ArrayList<Employee> getAllSalaries()
    {
        try
        {
            // Create an SQL statement
            ...
            String strSelect =
                    "SELECT employees.emp_no, employees.first_name, employees.last_name, salaries.salary "
                            ...
                            "AND salaries.to_date = '9999-01-01'" +
                            "AND titles.to_date = '9999-01-01'" +
                            "AND titles.title = 'Engineer' " +"ORDER BY employees.emp_no ASC";
            // Execute SQL statement
            ResultSet rset = stmt.executeQuery(strSelect);
  ...
  /*  public void printSalaries(ArrayList<Employee> employees)
     ...
     * @return A list of all employees and salaries, or null if there is an error.
     */
    public ArrayList<Employee> getAllSalaries() { //second get salary to test labs
        try {
            // Create an SQL statement
            Statement stmt = con.createStatement();
            // Create string for SQL statement
  ...
  public Department getDepartment(String dept_name){
    ...
    public void printSalariesdept(ArrayList<Employee> employees) {
        // Print header
        System.out.println(String.format("%-10s %-15s %-20s %-8s", "Emp No", "First Name", "Last Name", "Salary"));
        // Loop over all employees in the list
        for (Employee emp : employees) {
